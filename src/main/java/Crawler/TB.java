...
public class TB implements Crawler {
    ...
    @Override
    public List<Goods> GetGoodsList(String keyword) throws NoSuchAlgorithmException, IOException, InterruptedException {
        // Get client
        HttpClient client = HttpClient.newBuilder().build();
        
        // Build Url with args
        String ep_data = BuildDataBody(keyword);
    ...
    private static String BuildDataBody(String keyword) {
        ...
        paramsMap.put("totalResults", 4800);
        paramsMap.put("sourceS", "0");
        paramsMap.put("sort", "_coefp");
        paramsMap.put("bcoffset", "");
        paramsMap.put("ntoffset", "");
